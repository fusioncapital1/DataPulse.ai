    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-section">
          <h3 className="footer-title">DataPulse.ai</h3>
          <p className="footer-description">
            Transform unstructured web data into actionable insights with our AI-powered data extraction platform.
          </p>
        </div>
      ...
      <div className="footer-bottom">
        ...
        <div className="social-links">
          ...
          <a href="https://github.com/fusioncapital1/datapulse-ai" aria-label="GitHub">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://linkedin.com/company/datapulseai" aria-label="LinkedIn">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
